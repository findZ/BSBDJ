//
//  BSCommunityDetailSubController.swift
//  BaiSi
//
...
class BSCommunityDetailSubController: BSBaseController {
    ...
    private lazy var tableView: UITableView = { [unowned self] in
        let tabV = UITableView.init(frame: CGRect.init(x: 0, y: 0, width: Screen_width, height: Screen_height - 44 - NAVIGATION_BAR_HEIGHT))
        ...
        tabV.mj_header = MJRefreshNormalHeader.init(refreshingBlock: {
            ...
            self.viewModel.loadCommuniityNewSubData()
        })
        tabV.mj_footer = MJRefreshBackStateFooter.init(refreshingBlock: {
            self.viewModel.loadCommuniityMoreSubData()
        })
        return tabV
        }()
...
extension BSCommunityDetailSubController : UITableViewDataSource, UITableViewDelegate {
...
extension BSCommunityDetailSubController : UIScrollViewDelegate {
...
extension BSCommunityDetailSubController : BSHomeSubCellDelegate{
...
extension BSCommunityDetailSubController {
...
extension BSCommunityDetailSubController : BSViewModelDelagate {
